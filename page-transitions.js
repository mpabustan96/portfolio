...
(function () {
  ...
  var THEMES = {
    ...
    'counseling.html': {
      name: 'Connett Family Counseling', bg: '#33454F', accent: '#A8C7AC',
      ...
      labelColor: '#A8C7AC', lineColor: 'rgba(231, 239, 232, 0.18)'
    },
    'ui-ux-nest.html': {
    ...
    'dhpa.html': {
      name: 'Data Handling Policy Assistant', bg: '#16232E', accent: '#C9A227',
